...
__device__ inline void md5Hash(unsigned char* data, uint32_t length, uint32_t *a1, uint32_t *b1, uint32_t *c1, uint32_t *d1, uint32_t a2, uint32_t b2, uint32_t c2, uint32_t d2){
  const uint32_t a0 = a2;
  const uint32_t b0 = b2;
  const uint32_t c0 = c2;
  const uint32_t d0 = d2;
  ...
  bitlen += 512; // add 512 bits because of the salt
